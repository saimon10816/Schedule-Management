    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center mb-5">
                <h2 class="heading-section">Attendance Management</h2>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-md-12">
                    ...
                    <div class="row no-gutters mb-5">
                        <div class="col-md-12">
                            <div class="contact-wrap w-100 p-md-5 p-4">
                                ...
                                <form action="{{route('admin.companyB.update', $companyBlists->id)}}" method="POST" id="contactForm" name="contactForm" class="contactForm">
                                    @csrf
                                    {{--                                    @method('PUT')--}}
                                    <div class="row">
                                        <div class="col-md-6">
